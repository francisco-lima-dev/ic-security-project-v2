Artefato do lote cves-sast-batch-ac — ferramenta snyk-code
====================================================================
...
preparado_em: 2026-09-17T01:05:50Z
...
normalize.py: rc=0
check-log.py: rc=0
portao de lote sem raw: OK — 28 de 30 CVEs do lote com raw
...
--- container
inicio: 2026-09-17T01:06:02Z
fim: 2026-09-17T01:13:38Z
duracao_segundos: 456
rc_container: 0
...
[tools/normalize.py]
  processados: 28 | pulados: 0 | com falha: 0
  linhas da lista sem raw: 195 | raws sem linha na lista: 0
  achados: 283 (sem CWE: 0)
[tools/check-log.py]
  linhas no log: 30 | CVEs distintos apos deduplicacao: 30 | raws: 28
  ultimo status por CVE: {'OK': 18, 'SEM_ACHADOS': 10, 'SEM_ARQUIVO_ANALISAVEL': 2}
