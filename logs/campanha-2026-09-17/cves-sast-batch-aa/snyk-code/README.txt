Artefato do lote cves-sast-batch-aa — ferramenta snyk-code
====================================================================
...
preparado_em: 2026-09-16T14:12:38Z
workflow_run_id: 35106944490
...
uid_do_runner: 1001
gid_do_runner: 1001
lista: datasets/listas/cves-sast-batch-aa
...
--- container
inicio: 2026-09-16T14:12:53Z
fim: 2026-09-16T14:19:48Z
duracao_segundos: 415
rc_container: 0
limite_do_lote_segundos: 5400 (teto 5400; decorrido no job ao iniciar 15; disponivel 6075)
...
[tools/normalize.py]
  ...
  achados: 275 (sem CWE: 0)
[tools/check-log.py]
  linhas no log: 30 | CVEs distintos apos deduplicacao: 30 | raws: 29
  ultimo status por CVE: {'ERRO_FETCH': 1, 'OK': 18, 'SEM_ACHADOS': 11}
