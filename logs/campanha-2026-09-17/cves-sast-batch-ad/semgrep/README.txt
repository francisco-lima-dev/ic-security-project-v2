Artefato do lote cves-sast-batch-ad — ferramenta semgrep
====================================================================
...
uid_do_runner: 1001
gid_do_runner: 1001
lista: datasets/listas/cves-sast-batch-ad
...
normalize.py: rc=0
check-log.py: rc=0
portao de lote sem raw: OK — 29 de 30 CVEs do lote com raw
rede do Semgrep: OPERA SEM REDE — scan com o pack vendorizado completou sob --network=none (rc=0, 1 arquivo(s) em paths.scanned, 109s).
...
fim: 2026-09-17T01:15:04Z
duracao_segundos: 529
rc_container: 0
limite_do_lote_segundos: 5400 (teto 5400; decorrido no job ao iniciar 21; disponivel 5469)
...
[tools/normalize.py]
  ...
  linhas da lista sem raw: 194 | raws sem linha na lista: 0
  achados: 621 (sem CWE: 0)
[tools/check-log.py]
  linhas no log: 30 | CVEs distintos apos deduplicacao: 30 | raws: 29
  ultimo status por CVE: {'ERRO_CHECKOUT': 1, 'OK': 22, 'SEM_ACHADOS': 7}
