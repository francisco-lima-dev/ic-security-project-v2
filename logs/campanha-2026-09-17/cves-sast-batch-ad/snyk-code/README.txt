Artefato do lote cves-sast-batch-ad — ferramenta snyk-code
====================================================================
...
normalize.py: rc=0
check-log.py: rc=0
portao de lote sem raw: OK — 27 de 30 CVEs do lote com raw
...
--- container
inicio: 2026-09-17T01:06:14Z
fim: 2026-09-17T01:15:34Z
duracao_segundos: 560
rc_container: 0
limite_do_lote_segundos: 5400 (teto 5400; decorrido no job ao iniciar 20; disponivel 6070)
...
[tools/normalize.py]
  processados: 27 | pulados: 0 | com falha: 0
  linhas da lista sem raw: 196 | raws sem linha na lista: 0
  achados: 711 (sem CWE: 0)
[tools/check-log.py]
  linhas no log: 30 | CVEs distintos apos deduplicacao: 30 | raws: 27
  ultimo status por CVE: {'ERRO_CHECKOUT': 1, 'OK': 15, 'SEM_ACHADOS': 12, 'SEM_ARQUIVO_ANALISAVEL': 2}
  (1) raw existe e o ultimo status e de erro: 0
  (2) status OK/SEM_ACHADOS e nao existe raw: 0
  (3) SEM_ARQUIVO_ANALISAVEL sem raw: 2  (ESPERADO — resultado, nao falha)
