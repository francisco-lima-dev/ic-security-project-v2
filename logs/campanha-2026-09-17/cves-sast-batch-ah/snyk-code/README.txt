Artefato do lote cves-sast-batch-ah — ferramenta snyk-code
====================================================================
...
preparado_em: 2026-09-17T01:05:58Z
...
fim: 2026-09-17T01:10:39Z
duracao_segundos: 269
rc_container: 0
limite_do_lote_segundos: 5400 (teto 5400; decorrido no job ao iniciar 12; disponivel 6078)
...
[tools/normalize.py]
  ...
  achados: 249 (sem CWE: 0)
[tools/check-log.py]
  linhas no log: 13 | CVEs distintos apos deduplicacao: 13 | raws: 13
  ultimo status por CVE: {'OK': 10, 'SEM_ACHADOS': 3}
