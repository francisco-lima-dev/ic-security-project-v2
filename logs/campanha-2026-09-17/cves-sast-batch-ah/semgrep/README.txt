Artefato do lote cves-sast-batch-ah — ferramenta semgrep
====================================================================
...
preparado_em: 2026-09-17T01:05:59Z
workflow_run_id: 35169213227
...
uid_do_runner: 1001
gid_do_runner: 1001
lista: datasets/listas/cves-sast-batch-ah
registros_na_lista: 13
linhas_fisicas_na_lista: 13
...
normalize.py: rc=0
check-log.py: rc=0
portao de lote sem raw: OK — 13 de 13 CVEs do lote com raw
rede do Semgrep: OPERA SEM REDE — scan com o pack vendorizado completou sob --network=none (rc=0, 1 arquivo(s) em paths.scanned, 111s).
...
--- container
inicio: 2026-09-17T01:06:15Z
fim: 2026-09-17T01:11:32Z
duracao_segundos: 317
rc_container: 0
limite_do_lote_segundos: 5400 (teto 5400; decorrido no job ao iniciar 16; disponivel 5474)
...
raws (CVE-*): 13
tratados (*.json): 13
linhas no log de execucao (com cabecalho): 14

--- portoes (linhas emitidas pelos proprios scripts)
[tests/run-fixtures.py]
250 verificacoes, 0 falha(s)
[tools/normalize.py]
  processados: 13 | pulados: 0 | com falha: 0
  linhas da lista sem raw: 210 | raws sem linha na lista: 0
  achados: 623 (sem CWE: 0)
[tools/check-log.py]
  linhas no log: 13 | CVEs distintos apos deduplicacao: 13 | raws: 13
  ultimo status por CVE: {'OK': 12, 'SEM_ACHADOS': 1}
  ...
  (4) CVE do lote sem raw e sem linha de log: 0 de 13
