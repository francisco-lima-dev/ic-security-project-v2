Artefato do lote cves-sast-batch-ag — ferramenta snyk-code
====================================================================
...
uid_do_runner: 1001
gid_do_runner: 1001
lista: datasets/listas/cves-sast-batch-ag
...
fim: 2026-09-17T01:14:39Z
duracao_segundos: 508
rc_container: 0
...
[tools/normalize.py]
  ...
  achados: 813 (sem CWE: 0)
[tools/check-log.py]
  linhas no log: 30 | CVEs distintos apos deduplicacao: 30 | raws: 30
  ultimo status por CVE: {'OK': 18, 'SEM_ACHADOS': 12}
