Artefato do lote cves-sast-batch-af — ferramenta snyk-code
====================================================================
...
preparado_em: 2026-09-17T01:05:57Z
...
uid_do_runner: 1001
gid_do_runner: 1001
lista: datasets/listas/cves-sast-batch-af
...
--- container
inicio: 2026-09-17T01:06:11Z
fim: 2026-09-17T01:16:03Z
duracao_segundos: 592
rc_container: 0
limite_do_lote_segundos: 5400 (teto 5400; decorrido no job ao iniciar 14; disponivel 6076)
...
[tools/normalize.py]
  ...
  achados: 336 (sem CWE: 0)
[tools/check-log.py]
  linhas no log: 30 | CVEs distintos apos deduplicacao: 30 | raws: 29
  ultimo status por CVE: {'OK': 20, 'SEM_ACHADOS': 9, 'SEM_ARQUIVO_ANALISAVEL': 1}
  (1) raw existe e o ultimo status e de erro: 0
  (2) status OK/SEM_ACHADOS e nao existe raw: 0
  (3) SEM_ARQUIVO_ANALISAVEL sem raw: 1  (ESPERADO — resultado, nao falha)
