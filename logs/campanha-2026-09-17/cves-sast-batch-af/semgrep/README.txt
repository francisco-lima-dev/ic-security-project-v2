Artefato do lote cves-sast-batch-af — ferramenta semgrep
====================================================================
...
fim: 2026-09-17T01:16:20Z
duracao_segundos: 610
rc_container: 0
limite_do_lote_segundos: 5400 (teto 5400; decorrido no job ao iniciar 13; disponivel 5477)
...
[tools/normalize.py]
  ...
  achados: 625 (sem CWE: 0)
[tools/check-log.py]
  linhas no log: 30 | CVEs distintos apos deduplicacao: 30 | raws: 30
  ultimo status por CVE: {'OK': 25, 'SEM_ACHADOS': 5}
